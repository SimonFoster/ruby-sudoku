...
char buf[buf_size];/*:8*//*14:*/
#line 260 "dance.w"
int level;
node*choice[max_level];/*:14*//*6:*/
#line 115 "dance.w"
print_row(p)
node*p;
{register node*q=p;
...
register node*pp;/*:13*//*20:*/
#line 337 "dance.w"
register int minlen;
register int j,k,x;/*:20*/
#line 40 "dance.w"
;
verbose=argc-1;
if(verbose)sscanf(argv[1],"%d",&spacing);/*7:*//*9:*/
#line 153 "dance.w"
cur_col=col_array+1;
...
#line 306 "dance.w"
for(pp=cur_node->right;pp!=cur_node;pp=pp->right)cover(pp->col);/*:17*/
#line 242 "dance.w"
;
...
recover:/*18:*/
#line 314 "dance.w"
for(pp=cur_node->left;pp!=cur_node;pp=pp->left)uncover(pp->col);/*:18*/
#line 250 "dance.w"
;
cur_node=choice[level]=cur_node->down;goto advance;
done:if(verbose>3)/*22:*/
#line 354 "dance.w"
{
